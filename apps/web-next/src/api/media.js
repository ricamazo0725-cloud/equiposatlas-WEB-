 ...
 * folder agrupa las imágenes dentro del bucket (ej. "hero", "maquinaria", "galeria").
 */
...
export async function deleteImageByUrl(url) {
  ...
  if (idx === -1) return; // no es una imagen de este bucket (ej. una URL externa) — no hay nada que borrar
